...
10 . Applications of different DS
=================================
...
21 . How strings are stored in memory
======================================
...
24 . Graph
==========
A graph is a collection of nodes (also called vertices) connected by edges. Graphs can represent many-to-many relationships.
...
25 . Tree
=========
 A tree is a special type of graph that is connected and acyclic. It has a hierarchical structure with a root node and subnodes (children).
